...
function PageTranslationGoogle() {
		...
		var fordUrl = "https://translate.google.com/translate?hl=" + cel + "&sl=auto&tl=" + cel + "&u=" + decodeURIComponent(docurl);
 ...
 function PageTranslationGoogleInPage() {
  ...
  function PageTranslationIciba() {
		...
		gBrowser.loadURI("javascript:void((function(){hjelm=document.createElement('script');hjelm.setAttribute('src','http://open.iciba.com/huaci/huaci.js');document.body.appendChild(hjelm);})())");
	};

function PageTranslationOpenWindowGoogle(event) {
window.open("https://translate.google.com/m/translate","谷歌翻译","resizable,scrollbars,status,title").resizeTo(400, 600);
};

function PageTranslationOpenWindowYoudao(event) {
window.open("http://m.youdao.com/dict?le=eng&q=a","有道翻译","resizable,scrollbars,status,title").resizeTo(400, 600);
};
