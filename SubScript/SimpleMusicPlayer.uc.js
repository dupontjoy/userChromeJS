...
(function(){
    ...
    var Sites = [
        ...
        },
		{
            ...
            iframeStyle: "width: 1010px; height: 664px;",
            ...
            css: ".site-title, .nm-page-header, container group, #masthead,#footer-widget-box,#nav-topbar.nav-container.group,.breadcrumb, #scroll li a.scroll-b,#scroll li a#gb2big5, footer{display:none;}#header{background-color: #DDDDDD;margin-top:-50px !important;}.nmplaybar.appear{height: 40px !important;}.nmplayer-info,.nmplayer-control{line-height:2px !important;}.play-thumb{right:0 !important;}.music-page-navi{margin-bottom:50px !important;}#nm-wrapper{margin-top:-20px !important;margin-left:-10px !important;margin-right:-10px !important;}.page-template-default #content {border:0px !important;}.page-template-default #content{background-color:#f6f6f6;}",
            control: {
                play: ".grobalPlayer",
                pause: ".pauseBtn",
                next: "#next",
