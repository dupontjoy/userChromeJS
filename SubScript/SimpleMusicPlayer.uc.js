...
(function(){
  ...
  {    
        ...
        },
        {
            ...
            control: {
                play: "#g_player .ply.j-flag",
                pause: "#g_player .ply.j-flag",
                next: "#g_player .nxt",
                prev: "#g_player .prv",
            },
            state: {
    ...
    /*     {
            name: "豆瓣FM",
            url: "http://douban.fm/",
            iframeStyle: "width: 1200x; height: 600px;",
            css: "",
            control: {
                play: ".bn-play",
                pause: ".bn-pause",
...
*/
          {
			...
			url: "http://douban.fm/",
			isWindow: true,
			windowFeatures: 'width=960px,height=650px,resizable,scrollbars=yes',
...
*/
        ...
        },
    {
        ...
        },
        {
            ...
            iframeStyle: "width: 500px; height: 650px;",
            css: ".app-bar.qq-dl.wrapper2, .footer.fixed, #footer, .dload-event, .app-bar.fixed.footer2{ display:none!important; }",
            control: {
                playPause: ".iconfont.icon-play2",
                prev: ".prevBtn",
                next: ".nextBtn",
            },
            state: {
        ...
        {
            name: "熔岩电台",
            url: "http://www.lavaradio.com/",
            openLinkInsided: true,
            iframeStyle: "width: 960px; height: 650px;",
            css: "#app-main-nav {margin-top: -120px;} #header {display: none !important;} #app-main-wrapper {margin-top: -120px; margin-right: -120px !important;} .ad-sidebar{display:none;}",
            control: {
                play: "icona-play",
                pause: "icona-pause",
                prev: ".icona-fast-backward",
                next: ".icona-fast-forward",
            },
            state: {
                isPlaying: "return doc.querySelector('#pause_layer').style.display == 'none';",
                isLoved: "return win.$('.bn-love').hasClass('bn-love-active');",
 ...
 */
{
            ...
            css: "#nm-wrapper .nm-list-content {width:190px !important;} .nmplayer-wrap{max-width:860px !important;} .header-content.wrapper, .header-nav, .footer{display:none !important;}",
            control: {
                play: "#nm_container .nm-play",
                pause: "#nm_container .nm-pause",
                next: "#nm_container .nm-next",
                prev: "#nm_container .nm-previous",
            },
            state: {
                isPlaying: "return doc.querySelector('#g_player .ply').classList.contains('pas')",
            }
